...
**** the result of this program is the cleaned IPEDS data for analysis: ipeds_cleaned_final_new  ****
*************************************************************************************************

clear
global PATH "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication"

cd "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Do"
/*
...
use directorymaster1_2018_new.dta
...
merge 1:1 unitid year using institutionmaster1_2018_new.dta
drop if _merge!=3
drop _merge
...
sort unitid year
merge 1:1 unitid year using gradmaster1_2018_new.dta
...
sort unitid year
merge 1:1 unitid year using revenuesmaster1_2018_new.dta
drop if _merge==2
drop _merge
...
sort unitid year
merge 1:1 unitid year using facultymaster1_2018_new.dta
drop if _merge==2
drop _merge
sort unitid year
merge 1:1 unitid year using tuitionmaster1_2018_new.dta
drop if _merge==2
drop _merge
...
save "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Data\Cleared data\ipeds_cleaned_final_new.dta", replace
