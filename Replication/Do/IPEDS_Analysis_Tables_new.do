...
****************************************************************
*** This program makes Tables 1, 2, 3. ***
****************************************************************
...
clear
global PATH "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication"

cd "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Data\Cleared data"

use ipeds_cleaned_final_new.dta, replace
...
log using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_1_new.txt", replace text
...
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_2_new", replace tex dec(3)  keep(semester2) 
*Column 2
areg costs                    semester2         i.year c.year#i.unitid       , absorb(unitid)  cluster(unitid) 
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_2_new", append tex dec(3)  keep(semester2) 
*Column 3
...
log using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_2_means_new.txt", replace text
...
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_3a_new", replace tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, No)
*Column 2
areg gradrate4yr  block1 block2  $timevar i.year      [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_3a_new", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, No)
*Column 3
areg gradrate4yr  block1 block2     i.year c.year#i.unitid  [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_3a_new", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, Yes)
*Column 4
areg gradrate4yr  block1 block2     i.year c.year#i.unitid $timevar   [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_3a_new", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, Yes)
*Column 5
...
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_3b_new", replace tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, No)
*Column 2
areg gradrate6yr  block1 block2  $timevar i.year      [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_3b_new", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, No)
*Column 3
areg gradrate6yr  block1 block2     i.year c.year#i.unitid  [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_3b_new", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, No, Time Trends, Yes)
*Column 4
areg gradrate6yr  block1 block2     i.year c.year#i.unitid $timevar   [aw=meansize]  , cluster(unitid) abs(unitid)
outreg2 using "C:\Users\dell\OneDrive - UW-Madison\Desktop\Replication\Output\table_3b_new", append tex dec(3)  keep(block1 block2   ) addtext(School FE, Yes, Year FE, Yes,Controls, Yes, Time Trends, Yes)
*Column 5
